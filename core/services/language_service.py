...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "settings_home_city": "Default City / Metro Area",
        ...
        "settings_exam_location": "🎓 Default Exam Campus / Location",
        "settings_exam_location_placeholder": "e.g. Politecnico di Torino, Corso Duca degli Abruzzi 24",
        "settings_exam_location_hint": "💡 Default campus address automatically assigned to all exams for accurate travel ETA.",
    ...
    "it": {
        ...
        "settings_home_city": "Città predefinita / Area Urbana",
        ...
        "settings_exam_location": "🎓 Sede / Campus Esami Predefinita",
        "settings_exam_location_placeholder": "es. Politecnico di Torino, Corso Duca degli Abruzzi 24",
        "settings_exam_location_hint": "💡 Indirizzo predefinito assegnato automaticamente a tutti gli esami per il calcolo dell'ETA.",
