...
Read [.agents/rules/flightdeck_workflow.md](.agents/rules/flightdeck_workflow.md) before making changes. It is the project’s required operating guide, including architecture boundaries, reminder invariants, and the platform-specific test/build/restart/verification workflow.
