...
def get_combo_title(animal: str, outfit: str) -> str:
    ...
    if active_lang == "it":
        titles_it = {
            ...
            ("fox", "racer"): "🏎️ Volpe Stratega del Circuito",
            ("fox", "agent"): "🕵️ Volpe Agente d'Élite",
            ("fox", "student"): "🎓 Volpe Genio Accademico",
            ("fox", "aviator"): "🪖 Volpe Asso Tattico",
            ("fox", "zen"): "🌸 Volpe Calma e Concentrata",
            ("fox", "chef"): "👨‍🍳 Volpe Gourmet",
            ("fox", "captain"): "🧑‍✈️ Comandante Volpe",
            ("fox", "gym"): "🏋️ Volpe Sprint & Agilità",
            ("penguin", "aviator"): "🪖 Pinguino Galante Aviatore",
            ("penguin", "captain"): "🧑‍✈️ Comandante Pinguino Elegante",
            ("penguin", "agent"): "🕵️ Agente Pinguino in Smoking",
            ("penguin", "student"): "🎓 Pinguino Laureato con Lode",
            ("penguin", "racer"): "🏎️ Pinguino Grand Prix",
            ("penguin", "chef"): "👨‍🍳 Pinguino Chef dell'Antartide",
            ("penguin", "zen"): "🌸 Pinguino Zen sui Ghiacci",
            ("penguin", "gym"): "🏋️ Pinguino Fitness sui Ghiacci",
            ("panda", "zen"): "🌸 Maestro Panda Zen",
            ("panda", "student"): "🎓 Panda Studioso da Biblioteca",
            ("panda", "aviator"): "🪖 Panda Aviatore Sereno",
            ("panda", "chef"): "👨‍🍳 Chef Panda del Bambù",
            ("panda", "racer"): "🏎️ Panda Turbo Drifter",
            ("panda", "captain"): "🧑‍✈️ Comandante Panda Relax",
            ("panda", "agent"): "🕵️ Agente Segreto Panda",
            ("panda", "gym"): "🏋️ Kung-Fu Fitness Panda",
            ("bunny", "concert"): "🎸 Coniglio Pop Star",
            ("owl", "concert"): "🎸 Gufo DJ dei Festival",
            ("duck", "concert"): "🎸 Anatra Star dei Concerti",
            ("platypus", "concert"): "🎸 Ornitorinco Rocker Segreto",
            ("squirrel", "concert"): "🎸 Scoiattolo Rocker",
            ("fox", "concert"): "🎸 Volpe Rocker Star",
            ("penguin", "concert"): "🎸 Pinguino Star del Palco",
            ("panda", "concert"): "🎸 Panda Beatmaker",
            ("bunny", "tuxedo"): "🤵 Coniglio in Smoking",
            ("owl", "tuxedo"): "🤵 Gufo in Smoking",
            ("duck", "tuxedo"): "🤵 Anatra in Smoking",
            ("platypus", "tuxedo"): "🕵️ Agente Perry in Smoking",
            ("squirrel", "tuxedo"): "🤵 Scoiattolo in Smoking",
            ("fox", "tuxedo"): "🤵 Volpe in Smoking",
            ("penguin", "tuxedo"): "🤵 Pinguino in Smoking",
            ("panda", "tuxedo"): "🤵 Panda in Smoking",
        }
    ...
    titles = {
        ...
        ("duck", "aviator"): "🪖 Classic Quak Aviatore",
        ...
        ("fox", "racer"): "🏎️ Tactical Circuit Fox",
        ("fox", "agent"): "🕵️ Elite Covert Fox",
        ("fox", "student"): "🎓 Academic Strategist Fox",
        ("fox", "aviator"): "🪖 Tactical Ace Fox",
        ("fox", "zen"): "🌸 Calm Focus Fox",
        ("fox", "chef"): "👨‍🍳 Gourmet Fox",
        ("fox", "captain"): "🧑‍✈️ Captain Fox",
        ("fox", "gym"): "🏋️ Agile Sprint Fox",
        ("penguin", "aviator"): "🪖 Dapper Aviator Penguin",
        ("penguin", "captain"): "🧑‍✈️ Fleet Commander Penguin",
        ("penguin", "agent"): "🤵 Tuxedo Agent Penguin",
        ("penguin", "student"): "🎓 Distinguished Scholar Penguin",
        ("penguin", "racer"): "🏎️ Grand Prix Penguin",
        ("penguin", "chef"): "👨‍🍳 Antarctic Chef Penguin",
        ("penguin", "zen"): "🌸 Glacial Zen Penguin",
        ("penguin", "gym"): "🏋️ Polar Fitness Penguin",
        ("panda", "zen"): "🌸 Zen Master Panda",
        ("panda", "student"): "🎓 Deep Focus Scholar Panda",
        ("panda", "aviator"): "🪖 Calm Aviator Panda",
        ("panda", "chef"): "👨‍🍳 Bamboo Chef Panda",
        ("panda", "racer"): "🏎️ Turbo Drifter Panda",
        ("panda", "captain"): "🧑‍✈️ Laid-back Captain Panda",
        ("panda", "agent"): "🕵️ Undercover Panda Operative",
        ("panda", "gym"): "🏋️ Kung-Fu Fitness Panda",
        ("bunny", "concert"): "🎸 Pop Star Bunny",
        ("owl", "concert"): "🎸 Festival DJ Owl",
        ("duck", "concert"): "🎸 Concert Rockstar Duck",
        ("platypus", "concert"): "🎸 Secret Rocker Platypus",
        ("squirrel", "concert"): "🎸 Rocker Squirrel",
        ("fox", "concert"): "🎸 Rocker Fox Pilot",
        ("penguin", "concert"): "🎸 Stage Headliner Penguin",
        ("panda", "concert"): "🎸 Beatmaker Panda",
        ("bunny", "tuxedo"): "🤵 Tuxedo Bunny",
        ("owl", "tuxedo"): "🤵 Tuxedo Owl",
        ("duck", "tuxedo"): "🤵 Tuxedo Duck",
        ("platypus", "tuxedo"): "🕵️ Secret Agent Perry in Tuxedo",
        ("squirrel", "tuxedo"): "🤵 Tuxedo Squirrel",
        ("fox", "tuxedo"): "🤵 Tuxedo Fox",
        ("penguin", "tuxedo"): "🤵 Tuxedo Penguin",
        ("panda", "tuxedo"): "🤵 Tuxedo Panda",
    }
