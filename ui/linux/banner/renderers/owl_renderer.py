...
class QtOwlRenderer(BaseQtPilotRenderer):
    def draw_pilot(self, p: QPainter, px: float, py: float, tick: int) -> None:
        p.setBrush(self._c(112, 71, 166))
        p.drawEllipse(QRectF(px - 44, py - 13, 76, 28))
        p.setBrush(self._c(179, 133, 102))
        p.drawEllipse(QRectF(px - 8, py + 2, 21, 21))
        p.setBrush(self._c(245, 240, 224))
        ...
        grad.closeSubpath()
        p.setBrush(self._c(31, 31, 41))
        p.drawPath(grad)

        tassel_wave = math.sin(tick * 0.2) * 3.0
        p.setBrush(self._c(255, 217, 51))
        ...
        p.setBrush(self._c(245, 240, 217))
        p.drawRoundedRect(QRectF(px - 24, py - 19, 18, 8), 2.5, 2.5)
        p.setBrush(self._c(230, 46, 46))
        ...
        wing.closeSubpath()
        p.setBrush(self._c(194, 133, 245))
        p.drawPath(wing)
